...
public class Checklist {
    ...
    private List<Tarefa> tarefas; //Lista de tarefas q podem ser gerenciadas
    ...
    public void alterarStatusTarefa(int id, boolean concluida) { //Dava pra fazer com stream porem não entendi a logica para usar ifPresent
