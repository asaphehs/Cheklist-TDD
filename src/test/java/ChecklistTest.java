...
public class ChecklistTest {
    ...
    public void testBuscarTodasAsTarefas() {
        ...
        assertEquals("Ir ao mercado", listas.get(0).getDescricao()); //Coloquei o get(0) para obter o primeiro elemento da lista pq tava dando erro
    ...
    public void testMarcarTarefaComoConcluida() {
        ...
        assertEquals("Lavar o carro", listas.get(1).getDescricao());//get 1 pois é o ultimo
